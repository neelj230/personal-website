...
export default function LocalClock({ visible }: LocalClockProps) {
  ...
  return (
    <>
      ...
      {/* Social icons — bottom left, aligned with nav bar */}
      <div
      ...
      >
        <a
          href="https://substack.com/@neelj23"
          target="_blank"
        ...
        <a
          href="https://www.linkedin.com/in/neel-jain-b3b3391a3/"
          target="_blank"
          rel="noopener noreferrer"
          className="social-icon"
          aria-label="LinkedIn"
        ...
        <a
          href="https://github.com/neelj230"
          target="_blank"
          rel="noopener noreferrer"
          className="social-icon"
          aria-label="GitHub"
        ...
        <a
          href="mailto:neelj@wharton.upenn.edu"
          className="social-icon"
          aria-label="Email"
        >
